...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-black/20 backdrop-blur-xs text-white py-1 z-10">
      <div className="container mx-auto px-2">
        <div className="flex justify-between items-center relative">
          ...
          <div className="w-1/3 flex justify-end items-center z-10">
            <h2 className="hidden sm:inline-block text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-purple-500 animate-pulse mr-2">
              Data Dynamics LLC
            </h2>
      ...
      <div className="absolute inset-0 bg-linear-to-r from-purple-500/5 to-cyan-400/5 pointer-events-none"></div>
    </footer>
  )
}